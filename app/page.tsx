...
export default function Page() {
  return (
    <>
      {/* 1. Static Background (Replaces Plasma) */}
      ...
      <main className="relative min-h-[100dvh] text-white selection:bg-lime-500/30">
        ...
        <section className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50 animate-in fade-in zoom-in-50 duration-1000">
            INITIATE YOUR <br/>
            <span className="text-lime-400">CAREER SEQUENCE</span>
          </h1>
          ...
          <div className="absolute bottom-10 left-0 w-full px-10 flex justify-between text-xs font-mono text-gray-600 uppercase tracking-widest hidden md:flex">
             <span> Coordinates: 34.0522° N, 118.2437° W</span>
             <span> Server Status: Nominal</span>
             <span> Active Cadets: 14,203</span>
          </div>
        </section>
